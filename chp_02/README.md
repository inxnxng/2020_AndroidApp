...
- [둘째마당 - 01,02 레이아웃 익히기](#둘째마당---0102-레이아웃-익히기)
  - [01 안드로이드 스튜디오와 친해지기](#01-안드로이드-스튜디오와-친해지기)
    - [Layout?](#layout)
    - [View?](#view)
    - [위젯과 레이아웃으로 구별되는 뷰](#위젯과-레이아웃으로-구별되는-뷰)
    - [Constraint?](#constraint)
    - [XML](#xml)
    - [파일 저장 위치](#파일-저장-위치)
  - [02 레이아웃 익히기](#02-레이아웃-익히기)
    - [뷰 영역 알아보기](#뷰-영역-알아보기)
    - [화면 생성과정 분석하기](#화면-생성과정-분석하기)
    - [뷰 정렬하기](#뷰-정렬하기)
    - [뷰 생성하기](#뷰-생성하기)
      - [Padding이나 Layout_Margin](#padding이나-layout_margin)
      - [여유 공간을 분할하는 layout_weight 속성](#여유-공간을-분할하는-layout_weight-속성)
    - [상대 레이아웃](#상대-레이아웃)
    - [테이블 레이아웃](#테이블-레이아웃)
